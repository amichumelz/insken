    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 flex flex-col">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div className="space-y-1.5">
              ...
              <p className="text-xs sm:text-sm text-muted-foreground">
                Sila lengkapkan butiran perniagaan anda. Pas kehadiran digital ber-QR akan dijana secara automatik.
              </p>
            </div>
            <div className="flex items-center gap-2 self-start sm:self-auto rounded-lg bg-muted/60 p-2.5 text-xs text-muted-foreground border">
              ...
              <span>Pengesahan IC Unik &amp; Laluan Kapasiti Automatik</span>
            </div>
          </div>
        </div>
      ...
      <footer className="border-t bg-card py-4 text-center text-xs text-muted-foreground">
        <div className="mx-auto max-w-5xl px-4 flex flex-col sm:flex-row items-center justify-between gap-2">
          ...
          <p className="text-[11px]">Portal Pendaftaran Peserta Dalam Talian</p>
        </div>
      </footer>
    </div>
  );
